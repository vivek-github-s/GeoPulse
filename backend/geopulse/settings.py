...
SECRET_KEY = 'django-insecure-kgpy9pox#qy2b6*v$6=y0rvbxn5*@a_0-*opubk$7z^%8$ki!2'
...
DATABASES = {
    'default': {
        ...
        'USER': 'admin',
        'PASSWORD': 'admin@123',
        'HOST': 'localhost',  # or 'postgres-db' if using Docker Compose
        'PORT': '5432',
    }
}

ASGI_APPLICATION = "geopulse.asgi.application"

CHANNEL_LAYERS = {
    "default": {
        "BACKEND": "channels_redis.core.RedisChannelLayer",
        "CONFIG": {
            "hosts": [("localhost", 6379)],  # for Docker, or use localhost if dev
        },
    },
}
